            ...
            try {
                ...
                if (ProtocolUtils.isJavaGenericSerialization(generic)) {
                    try {
                        ...
                        RpcResult rr = new RpcResult(os.toByteArray());
                        rr.setNotifications(result.getNotifications());
                        return rr;
                    } catch (IOException e) {
...
//                    return new RpcResult(JavaBeanSerializeUtil.serialize(result.getValue(), JavaBeanAccessor.METHOD));
                    RpcResult rr = new RpcResult(JavaBeanSerializeUtil.serialize(result.getValue(), JavaBeanAccessor.METHOD));
                    rr.setNotifications(result.getNotifications());
                    return rr;
                } else {
//                    return new RpcResult(PojoUtils.generalize(result.getValue()));
                    RpcResult rr = new RpcResult(PojoUtils.generalize(result.getValue()));
                    rr.setNotifications(result.getNotifications());
                    return rr;
                }
